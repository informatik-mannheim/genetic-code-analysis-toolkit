package bio.gcat.geneticcode.exec

import bio.gcat.geneticcode.dich.BinaryAlgorithm
import bio.gcat.geneticcode.dich.scan.{ScanNumberOfClassesScan, ConcClassPower2Scan, ClassPower2Scan, ErrorScan}
import bio.gcat.util.{Version, ArgsParser}
