...
import bio.gcat.geneticcode.core.{UnknownCodonMapping, AminoAcidMapping}
...
class MutuableCodeTable extends AbstractBioJavaTable {
  ...
  val map = new HashMap[Codon, AminoAcidMapping]

  val counter = new HashMap[Codon, Int]

  def add(codon: Codon, mapping: AminoAcidMapping) {
