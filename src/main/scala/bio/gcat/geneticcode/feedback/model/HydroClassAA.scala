package bio.gcat.geneticcode.feedback.model

import bio.gcat.geneticcode.feedback
import bio.gcat.geneticcode.core.{RNASequence, tRNASequence}
import bio.gcat.geneticcode.feedback.EvolvedGeneticCode
...
class HydroClassAA(thres: Double, initTable: feedback.MutuableCodeTable, randomGen: Random)
  extends EvolvedGeneticCode(thres, initTable, randomGen) with feedback.HydroMapper {
