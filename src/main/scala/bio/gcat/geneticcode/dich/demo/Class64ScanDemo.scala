...
import bio.gcat.geneticcode.dich.scan.{ConcClassPower2Scan, ClassPower2Scan, IncreaseScan}
import bio.gcat.geneticcode.dich.{BinaryDichotomicAlgorithm => BDA, Adenine => A, Uracil => U, Guanine => G, Cytosine => C, _}
