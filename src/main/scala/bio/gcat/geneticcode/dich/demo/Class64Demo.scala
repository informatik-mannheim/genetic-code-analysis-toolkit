...
class Class64Demo {
  ...
  def example001() {
    val bdas = List(
      ...
      new BinaryDichotomicAlgorithm(2, 1, (A, U), Set(U, G)),
      new BinaryDichotomicAlgorithm(2, 1, (C, G), Set(A, C))
    )
    printLaTex(bdas)
  }
  ...
  def example002() {
    val bdas = List(
      new BinaryDichotomicAlgorithm(0, 1, (A, U), Set(C, G)),
      new BinaryDichotomicAlgorithm(0, 1, (C, G), Set(A, G)),
      new BinaryDichotomicAlgorithm(0, 1, (C, G), Set(U, C)),
      new BinaryDichotomicAlgorithm(2, 1, (A, G), Set(U, G)),
      new BinaryDichotomicAlgorithm(2, 1, (U, C), Set(A, C)),
      new BinaryDichotomicAlgorithm(2, 1, (U, C), Set(U, G))
    )
    printLaTex(bdas)
  }
  ...
  def example003() {
    val bdas = List(
      ...
      new BinaryDichotomicAlgorithm(0, 1, (C, G), Set(A, U)),
      new BinaryDichotomicAlgorithm(0, 2, (A, U), Set(A, U))
    )
  ...
  def exampleAlberto8BioBDAExample64() {
    val bdas = List(
      ...
      new BinaryDichotomicAlgorithm(1, 2, (A, U), Set(C, G)),
      new BinaryDichotomicAlgorithm(1, 2, (C, G), Set(C, G))
    )
    printAll(bdas)
  }
  ...
  def exampleAlbertoHammingDist2() {
    val bdas = List(
      ...
      new BinaryDichotomicAlgorithm(0, 1, (A, U), Set(A, U)),
      new BinaryDichotomicAlgorithm(0, 1, (A, U), Set(A, U)),
      new BinaryDichotomicAlgorithm(0, 1, (A, G), Set(A, G)),
      new BinaryDichotomicAlgorithm(1, 2, (U, G), Set(A, G)),
  ...
  def example64classesSpecificBDAs() {
    val bdas = List(
      new BinaryDichotomicAlgorithm(0, 2, (G, C), Set(U, C)),
      new BinaryDichotomicAlgorithm(2, 1, (A, G), Set(G, U)),
  ...
  def printAll(bdas: List[BinaryDichotomicAlgorithm]) {
  ...
  def printLaTex(bdas: List[BinaryDichotomicAlgorithm]) {
    val t = new ClassTable(bdas)
    println(t.classes.size)
    println(t.mkString)
    println(t.laTeXMkString)
